...
//This function is used to analysis the clauses in the sql statement
//typical caluses inlcude select clause, from clause, join clause and so on methiod in the following code
func (p *Parser) Parse() (*ast.SelectStatement, error) {
	...
	if fields, err := p.parseFields(); err != nil {
		...
		fmt.Println("Parser get fileds in the select clause for constucting the  SelectStatement............")
	...
	if src, err := p.parseSource(); err != nil {
		...
		fmt.Println("Parser get fileds in the from clause for constucting the  SelectStatement............")
		selects.Sources = src
	}
	p.clause = "join"
	if joins, err := p.parseJoins(); err != nil {
		...
		fmt.Println("Parser get joins in the from clause for constucting the  SelectStatement............")
		selects.Joins = joins
	}
	p.clause = "where"
...
func (p *Parser) parseSource() (ast.Sources, error) {
	...
	if src, alias, err := p.parseSourceLiteral(); err != nil {
		...
		fmt.Println("parseSource get the source....................", src)
...
func (p *Parser) parseFields() (ast.Fields, error) {
	...
	for {
		...
		if err != nil {
			...
			fmt.Println("parseFields get the field........................")
		}
...
func (p *Parser) parseField() (*ast.Field, error) {
	...
	//fmt.Println("parseField is called.................", field.Name)
	return field, nil
}
...
func (p *Parser) ParseCreateStmt() (ast.Statement, error) {
	...
	if lit == ast.CREATE {
		...
		if tok2, lit2 := p.scanIgnoreWhitespace(); tok2 == ast.IDENT {
			...
			fmt.Println(".............sssin create statmen is ....", lit, lit1, lit2)
