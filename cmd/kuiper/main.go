	...
	app.Commands = []cli.Command{
		...
		},
		{
			...
			Subcommands: []cli.Command{
				...
				//how many message are being processed last arg1 seconds
				{
					Name:  "ProcessedMessageCount",
					Usage: "describe ProcessedMessageCount $arg1",
					Action: func(c *cli.Context) error {
						if len(c.Args()) != 1 {
							fmt.Printf("Expect 1 arguments.\n")
							return nil
						}
						arg1 := c.Args()[0]
						var reply string
						err = client.Call("Server.ProcessedMessageCount", arg1, &reply)
						if err != nil {
							fmt.Println(err)
						} else {
							fmt.Println(reply)
				...
				{
					Name:  "IncomingMessageCount",
					Usage: "describe IncomingMessageCount $arg1",
					Action: func(c *cli.Context) error {
						if len(c.Args()) != 1 {
							fmt.Printf("Expect 1 arguments.\n")
							return nil
						...
						arg1 := c.Args()[0]
						var reply string
						err = client.Call("Server.IncomingMessageCount", arg1, &reply)
						if err != nil {
							fmt.Println(err)
						} else {
							fmt.Println(reply)
				...
				{
					Name:  "CompletedRuleCount",
					Usage: "describe CompletedRuleCount $arg1",
					Action: func(c *cli.Context) error {
						if len(c.Args()) != 1 {
							fmt.Printf("Expect 1 arguments.\n")
							return nil
						...
						arg1 := c.Args()[0]
						var reply string
						err = client.Call("Server.CompletedRuleCount", arg1, &reply)
						if err != nil {
							fmt.Println(err)
						} else {
							fmt.Println(reply)
				...
				{
					Name:  "RuleCompletionCount",
					Usage: "describe RuleCompletionCount $arg1",
					Action: func(c *cli.Context) error {
						if len(c.Args()) != 1 {
							fmt.Printf("Expect 1 arguments.\n")
							return nil
						...
						arg1 := c.Args()[0]
						var reply string
						err = client.Call("Server.RuleCompletionCount", arg1, &reply)
						if err != nil {
							fmt.Println(err)
						} else {
							fmt.Println(reply)
				...
				{
					Name:  "RuleAverageTimeSpend",
					Usage: "describe RuleAverageTimeSpend $arg1",
					Action: func(c *cli.Context) error {
						if len(c.Args()) != 1 {
							fmt.Printf("Expect 1 arguments.\n")
							return nil
						...
						arg1 := c.Args()[0]
						var reply string
						err = client.Call("Server.RuleAverageTimeSpend", arg1, &reply)
						if err != nil {
							fmt.Println(err)
						} else {
							fmt.Println(reply)
