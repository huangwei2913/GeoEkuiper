...
func createRestServer(ip string, port int, needToken bool) *http.Server {
	...
	fmt.Println("createRestServer with ip and port is ...............", ip, port)
	...
	for k, v := range components {
		...
		//fmt.Println("register rest endpoint for component ....", k)
		v.rest(r)
	}
...
func rulesHandler(w http.ResponseWriter, r *http.Request) {
	...
	case http.MethodPost:
		...
		result := fmt.Sprintf("Rule %s was created successfully.......huauauauuauauxxxx.", id)
		fmt.Println(result)
		w.WriteHeader(http.StatusCreated)
		w.Write([]byte(result))
	case http.MethodGet:
